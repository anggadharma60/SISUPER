    ...
    <header class="main-header">
      ...
      <?php if ($this->fungsi->user_login()->level == 1) { ?>
        ...
        <?php if ($this->fungsi->user_login()->level == 2) { ?>
          <a href="<?= base_url('KetuaRW') ?>" class="logo">
          <?php } ?>
          <?php if ($this->fungsi->user_login()->level == 3) { ?>
            <a href="<?= base_url('KetuaRT') ?>" class="logo">
            <?php } ?>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          <li>
            <?php if ($this->fungsi->user_login()->level == 1) { ?>
              ...
              <?php } ?>
              <?php if ($this->fungsi->user_login()->level == 2) { ?>
                <a href="<?= site_url('KetuaRW') ?>">
                <?php } ?>
                <?php if ($this->fungsi->user_login()->level == 3) { ?>
                  <a href="<?= site_url('KetuaRT') ?>">
                  <?php } ?>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <?php } ?>
              <?php if ($this->fungsi->user_login()->level == 2) { ?>
                <li><a href="<?= site_url('KetuaRW/getPenduduk') ?>"><i class="fa fa-users"></i> Data Penduduk</a></li>
              <?php } ?>
              <?php if ($this->fungsi->user_login()->level == 3) { ?>
                <li><a href="<?= site_url('KetuaRT/getPenduduk') ?>"><i class="fa fa-users"></i> Data Penduduk</a></li>
              <?php } ?>
          ...
          <?php } ?>
          <?php if ($this->fungsi->user_login()->level == 2) { ?>
            <a href="<?= site_url('KetuaRW/getSurat') ?>">
              <i class="fa fa-envelope"></i> <span>Surat Pengantar</span>
              <span class="pull-right-container">
              </span>
            </a>
          <?php } ?>
          <?php if ($this->fungsi->user_login()->level == 3) { ?>
            <a href="<?= site_url('KetuaRT/getSurat') ?>">
              <i class="fa fa-envelope"></i> <span>Surat Pengantar</span>
              <span class="pull-right-container">
              </span>
            </a>
          ...
          <li>
            <a href="<?= site_url('Autentikasi/logout') ?>">
